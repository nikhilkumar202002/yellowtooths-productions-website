...
const HomeContact = () => {
  return (
    <section className="overflow-hidden border-b border-white/15 bg-black text-white">
      <Container>
        <div className="grid min-h-[680px] lg:grid-cols-[1.1fr_0.9fr]">
          <div className="border-b border-white/20 py-14 lg:border-r lg:border-b-0 lg:py-20 lg:pr-14">
            <p className="font-description text-xs uppercase tracking-[0.18em] text-white/50">
              Start a conversation
            </p>
            <h2 className="font-heading mt-5 max-w-2xl text-[clamp(2.5rem,5vw,5rem)] leading-[0.98] tracking-[-0.06em]">
              Let&apos;s make something worth remembering.
            </h2>

            <div className="mt-10 grid gap-8 md:grid-cols-[minmax(0,1.4fr)_minmax(180px,0.6fr)]">
              <div className="relative min-h-[240px] overflow-hidden bg-black sm:min-h-[280px]">
                <iframe
